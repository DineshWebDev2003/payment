...
<head>
  ...
  <title>kolathur - Fees Payment</title>
  <link rel="stylesheet" href="style.css">
</head>
<body>
  <div class="container">
    <h1>Pay Fees - kolathur</h1>
    <div class="qr-section">
      <h3>Scan the QR Code or Use UPI ID</h3>
      <img id="qrCode" src="kolathur-qr.png" alt="QR Code" style="max-width: 200px;">
      <p><strong>UPI ID:</strong> kolathur@upi</p>
    ...
    <form id="paymentForm" action="" method="POST" enctype="multipart/form-data">
      ...
      <div>
        ...
        <input type="text" id="branch" value="kolathur" readonly>
        <input type="hidden" name="branch" value="kolathur">
      </div>
